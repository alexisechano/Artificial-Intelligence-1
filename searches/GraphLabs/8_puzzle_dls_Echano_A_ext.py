#   Alexis Echano P7
#   DLS 8 Puzzle EXTENSTION (ITERATIVE, NOT OPTIMIZED FOR >18)
...
def iterDLS(start, goal):  # recurs DLS but with iterative deepening
    explo = {start: ""}
    limit = 0
    test = DLS_recur_helper(start, explo, goal, limit)
...
def main():
    ...
    if (len(initialState) == 9):    #   makes sure no invalids
        ...
        shortestPath = iterDLS(initialState, goalState)  #   actually finds path using DFS
